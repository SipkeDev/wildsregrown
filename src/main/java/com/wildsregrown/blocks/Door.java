...
public class Door extends Block implements Waterloggable {
    ...
    public Door(Settings settings) {
        super(settings);
        setDefaultState(getDefaultState().with(OPEN, false).with(FACING, Direction.NORTH).with(Properties.WATERLOGGED, Boolean.FALSE));
    }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder){
        builder.add(OPEN, PART, FACING, Properties.WATERLOGGED);
    }
