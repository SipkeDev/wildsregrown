...
import com.wildsregrown.blocks.abstracts.VerticalConnectingBlock;
...
public class TudorVertical extends VerticalConnectingBlock implements ITintedBlock {

    private static final VoxelShape[] shape;
    private static final EnumProperty<VerticalConnected> SHAPE = ModProperties.VERTICAL_CONNECTED;
    ...
    public TudorVertical(Settings setting){
        super(setting);
