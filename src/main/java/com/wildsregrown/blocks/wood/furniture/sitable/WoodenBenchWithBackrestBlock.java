...
public class WoodenBenchWithBackrestBlock extends HorizontalConnectingBlock implements ITintedBlock {
    ...
    public WoodenBenchWithBackrestBlock(Settings settings){
        super(settings);
    ...
    public boolean isConnectingBlock(BlockState state, BlockState current) {
        return state.getBlock() instanceof WoodenBenchWithBackrestBlock;
    }
    ...
    static {
        ...
        single[0] = VoxelShapes.union(
                VoxelShapes.cuboid(0, 0.3125, 0.4375, 1, 0.375, 0.5),
                VoxelShapes.cuboid(0, 0.125, 0, 1, 0.375, 0.4375),
                VoxelShapes.cuboid(0.0125, 0, 0.0125, 0.1375, 0.125, 0.1375),
                VoxelShapes.cuboid(0.0125, 0, 0.29375, 0.1375, 0.125, 0.41875),
                VoxelShapes.cuboid(0.85625, 0, 0.29375, 0.98125, 0.125, 0.41875),
                VoxelShapes.cuboid(0.85625, 0, 0.0125, 0.98125, 0.125, 0.1375),
                VoxelShapes.cuboid(0, 0.375, 0, 0.125, 0.875, 0.125),
                VoxelShapes.cuboid(0.875, 0.375, 0, 1, 0.875, 0.125),
                VoxelShapes.cuboid(0.9375, 0.375, 0.125, 1, 0.625, 0.5),
                VoxelShapes.cuboid(0, 0.375, 0.125, 0.0625, 0.625, 0.5),
                VoxelShapes.cuboid(0.125, 0.3625, 0.06875, 0.875, 0.70625, 0.109375)
        );
        ...
        middle[0] = VoxelShapes.union(
                VoxelShapes.cuboid(0, 0.3125, 0.4375, 1, 0.375, 0.5),
                VoxelShapes.cuboid(0, 0.125, 0, 1, 0.375, 0.4375),
                VoxelShapes.cuboid(0, 0.3625, 0.06875, 1, 0.70625, 0.109375),
                VoxelShapes.cuboid(0, 0.6875, 0, 1, 0.75, 0.0625),
                VoxelShapes.cuboid(0.46875, 0, 0.0125, 0.59375, 0.125, 0.1375),
                VoxelShapes.cuboid(0.46875, 0, 0.29375, 0.59375, 0.125, 0.41875)
        );
        ...
        left[0] = VoxelShapes.union(
                ...
                VoxelShapes.cuboid(0, 0.125, 0, 1, 0.375, 0.4375),
                VoxelShapes.cuboid(0, 0.375, 0, 0.125, 0.875, 0.125),
                VoxelShapes.cuboid(0.125, 0.3625, 0.06875, 1, 0.70625, 0.109375),
                VoxelShapes.cuboid(0.125, 0.6875, 0, 1, 0.75, 0.0625),
                VoxelShapes.cuboid(0.03125, 0.375, 0.125, 0.09375, 0.625, 0.5),
                VoxelShapes.cuboid(0.0125, 0, 0.0125, 0.1375, 0.125, 0.1375),
                VoxelShapes.cuboid(0.0125, 0, 0.29375, 0.1375, 0.125, 0.41875)
        );
