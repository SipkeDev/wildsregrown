...
public class WoodenChair extends Block implements ITintedBlock {
    ...
    public WoodenChair(Settings settings, float height){
        super(settings);
    ...
    static {
        ...
        shapes[0] = VoxelShapes.union(
                ...
                VoxelShapes.cuboid(0.125, 0, 0.6875, 0.25, 0.375, 0.875),
                VoxelShapes.cuboid(0.125, 0.5, 0.75, 0.25, 1, 0.875),
                VoxelShapes.cuboid(0.4375, 0.5, 0.75, 0.5625, 1, 0.875),
                VoxelShapes.cuboid(0.125, 0, 0.125, 0.25, 0.375, 0.3125),
                VoxelShapes.cuboid(0.75, 0, 0.125, 0.875, 0.375, 0.3125),
                VoxelShapes.cuboid(0.75, 0, 0.6875, 0.875, 0.375, 0.875),
                VoxelShapes.cuboid(0.75, 0.5, 0.75, 0.875, 1, 0.875),
                VoxelShapes.cuboid(0.125, 1, 0.75, 0.875, 1.125, 0.875),
                VoxelShapes.cuboid(0.25, 0.6875, 0.78125, 0.75, 0.8125, 0.84375)
        );
