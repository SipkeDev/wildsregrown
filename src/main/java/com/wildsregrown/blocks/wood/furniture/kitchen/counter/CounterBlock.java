package com.wildsregrown.blocks.wood.furniture.kitchen.counter;
...
public class CounterBlock extends CornerConnectingBlock implements ITintedBlock {
    ...
    public CounterBlock(Settings settings){
        super(settings);
        this.setDefaultState(getDefaultState().with(Properties.HORIZONTAL_FACING, Direction.NORTH).with(PAINT, LinSeedPaintable.NONE).with(Properties.STAIR_SHAPE, StairShape.STRAIGHT));
    }
    ...
    static {
        ...
        straight[0] = VoxelTransform.mirrorX(VoxelShapes.union(
