...
public class TallThinGrassfield extends Biome {

    public TallThinGrassfield() {
        super(modid, "tall_thin_grassfield");
        register(Floras.tall_thin_grass, FloraSpawnRule.grouped, 0f, 1,false);
