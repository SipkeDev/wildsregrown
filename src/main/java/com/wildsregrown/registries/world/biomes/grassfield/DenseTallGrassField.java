...
public class DenseTallGrassField extends Biome {

    public DenseTallGrassField() {
        super(modid, "dense_tall_grassfield");
        setTreeDensity(12f);
    ...
    public Noise surfaceNoise(Seed seed, float value) {
        return NoiseGenerator.cubic(seed.next(), 256).fbm(3);
    }
