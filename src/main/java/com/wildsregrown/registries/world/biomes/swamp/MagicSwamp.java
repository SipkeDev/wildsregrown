...
public class MagicSwamp extends Biome {

    public MagicSwamp() {
        super(modid, "magic_swamp");
        ...
        register(new LakeFeature(NoiseGenerator.simplex(getKey().hashCode(), 256).ridged(3).map(0.215f, 0.57f), 5));
    }
