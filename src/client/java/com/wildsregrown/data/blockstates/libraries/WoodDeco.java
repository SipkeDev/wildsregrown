...
public class WoodDeco {
    ...
    private final static String modelPath = "block/decoration/wood/";
    ...
    public static void stool(BlockStateModelGenerator generator, Block block, String id, String name) {
        ...
        applyTextureToModel(generator, loc0, "block/furniture/wood_stool",log_path + name + "_wood");
        if (pines) {
            applyTextureToModel(generator, loc1, "block/furniture/wood_stool", log_path + "pine_paintable_wood");
        }else if (fruit) {
            applyTextureToModel(generator, loc1, "block/furniture/wood_stool",log_path + "fruit_paintable_wood");
        }else {
            applyTextureToModel(generator, loc1, "block/furniture/wood_stool",log_path + name + "_paintable_wood");
        }
        generator.registerParentedItemModel(block, Identifier.of(modid, loc0));
        BlockStateVariantMap.SingleProperty<WeightedVariant,LinSeedPaintable> map = BlockStateVariantMap.models(ModProperties.LINSEED_PAINT);
        for (LinSeedPaintable paint : ModProperties.LINSEED_PAINT.getValues()){
