...
public class StoneGroupBlockStates {
    ...
    public void build(StoneGroup group) {
        ...
        block = group.get(StoneGroup.Common.quarter_stairs);
        BlockStateLibrary.quarterStairs(generator, idFromBlock(block), block, texture);
        block = group.get(StoneGroup.Common.half_stairs);
        ...
        block = group.get(StoneGroup.Common.cobble_half_stairs);
        BlockStateLibrary.halfStairs(generator, idFromBlock(block), block, texture + "_cobble");
        ...
        if (group.constructionExist()) {
            ...
            block = group.get(StoneGroup.Construction.bricks_quarter_stairs);
            BlockStateLibrary.quarterStairs(generator, idFromBlock(block), block, texture);
            block = group.get(StoneGroup.Construction.bricks_half_stairs);
            BlockStateLibrary.halfStairs(generator, idFromBlock(block), block, texture + "_bricks");
            ...
            block = group.get(StoneGroup.Construction.pavement_quarter_stairs);
            BlockStateLibrary.quarterStairs(generator, idFromBlock(block), block, texture);
            block = group.get(StoneGroup.Construction.pavement_half_stairs);
            BlockStateLibrary.halfStairs(generator, idFromBlock(block), block, texture + "_pavement");
            ...
            block = group.get(StoneGroup.Construction.cobble_bricks_quarter_stairs);
            BlockStateLibrary.quarterStairs(generator, idFromBlock(block), block, texture);
            block = group.get(StoneGroup.Construction.cobble_bricks_half_stairs);
            BlockStateLibrary.halfStairs(generator, idFromBlock(block), block, texture + "_cobble" + "_bricks");
            ...
            block = group.get(StoneGroup.Construction.cobble_pavement_quarter_stairs);
            BlockStateLibrary.quarterStairs(generator, idFromBlock(block), block, texture);
            block = group.get(StoneGroup.Construction.cobble_pavement_half_stairs);
            BlockStateLibrary.halfStairs(generator, idFromBlock(block), block, texture + "_cobble" + "_pavement");
