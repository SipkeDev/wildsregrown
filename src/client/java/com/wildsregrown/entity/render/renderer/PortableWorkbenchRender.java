...
public class PortableWorkbenchRender implements BlockEntityRenderer<PortableWorkbenchEntity, RenderState> {
    ...
    @Override
    public void updateRenderState(PortableWorkbenchEntity blockEntity, RenderState renderState, float tickProgress, Vec3d cameraPos, @Nullable ModelCommandRenderer.CrumblingOverlayCommand crumblingOverlay) {
