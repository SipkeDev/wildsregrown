...
public record RenderArch(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2fStack stack,
        ...
        public RenderArch(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2fStack stack, int cx, int cy, double start, double end, float radius, int color, @Nullable ScreenRect bounds) {
